...
deleteItem = () => {this.props.cbDeleted(this.props.code)}
...
render() {
    return (
        <tr key={this.props.code} className='item'
            ...
            style={{background: this.props.isSelected && !(this.props.add) && this.props.mode!==0 ? 'orange' : 'white'}}>
            <td className='field'>{this.props.name}</td>
            <td className='field'>{this.props.price}</td>
            <td className='field'>{this.props.url}</td>
            <td className='field'>{this.props.inStock}</td>
            <td className='field'>
